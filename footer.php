<?php
echo'  <div class="bloc b-parallax tc-white bloc-bg-texture texture-darken-strong bg-Creativity-201 bgc-white" id="counts">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row creativity-center">
                            <div class="col-sm-12"><a href="http://facebook.com/codeinstituteaustria" class="btn btn-d btn-lg creativity-social-button" target="_blank"><span class="special-tag-for-editing-text-with-html"></span><span class="fa fa-facebook-official creativity-social-icon"></span></a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bloc tc-white bgc-onyx-2 d-bloc" id="footer">
            <div class="container bloc-md">
                <div class="row voffset">
                    <div class="col-sm-3">
                        <h1 class="mg-md creativity-logo" href=index.php>CIA<br></h1></div>
                    <div class="col-sm-3">
